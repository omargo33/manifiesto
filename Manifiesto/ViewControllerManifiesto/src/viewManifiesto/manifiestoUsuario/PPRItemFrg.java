  ...
  import viewManifiesto.manifiestoUsuario.PPRItemFrg;
    ...
    extends BasePPR
  {
    ...
    public String actionGuardar() {
      ...
      if (estado) {
        if (ADFUtils.commitRollback(getBindings(), "Commit", "Rollback", 
            getBundle("msg_guardar_ko", new Object[0]), getBundle("msg_guardar_ok", new Object[0]))) {
    ...
    public void setSoc6(RichSelectOneChoice soc6) { this.soc6 = soc6; }
  
  
    
    public RichSelectOneChoice getSoc6() { return this.soc6; }
    ...
    public void setIt15(RichInputText it15) { this.it15 = it15; }
    ...
    public void setIt18(RichInputText it18) { this.it18 = it18; }
    ...
    public void setIt19(RichInputText it19) { this.it19 = it19; }
    ...
    public void setIt21(RichInputText it21) { this.it21 = it21; }
  
  
  
    
    public int getIt19Int() { return this.it19Int; }
    ...
    public int getIt20Int() { return this.it20Int; }
    ...
    public int getIt21Int() { return this.it21Int; }
    ...
    public void setPfl5(RichPanelFormLayout panelFormInternacional) { this.pfl5 = panelFormInternacional; }
  
  
    
    public RichPanelFormLayout getPfl5() { return this.pfl5; }
    ...
    public void setIt6(RichInputText it6) { this.it6 = it6; }
  
  
    
    public RichInputText getIt6() { return this.it6; }
  
  
    
    public void setIt7(RichInputText it7) { this.it7 = it7; }
    ...
    public void setIt8(RichInputText it8) { this.it8 = it8; }
  
  
    
    public RichInputText getIt8() { return this.it8; }
  
  
    
    public void setIt9(RichInputText it9) { this.it9 = it9; }
    ...
    public void setIt11(RichInputText it11) { this.it11 = it11; }
    ...
    public void setIt12(RichInputText it12) { this.it12 = it12; }
    ...
    public void setIt13(RichInputText it13) { this.it13 = it13; }
    ...
    public void setIt200(RichInputText it200) { this.it200 = it200; }
    ...
    public void setIt210(RichInputText it210) { this.it210 = it210; }
    ...
    public void setIt190(RichInputText it190) { this.it190 = it190; }
    ...
    public boolean isCrear() { return verificarPermiso("#{pageFlowScope.pPermisoCrear}"); }
    ...
    public boolean isActualizar() { return verificarPermiso("#{pageFlowScope.pPermisoActualizar}"); }
    ...
    public boolean isBorrar() { return verificarPermiso("#{pageFlowScope.pPermisoBorrar}"); }
    ...
    public void setIt180(RichInputText it180) { this.it180 = it180; }
  
  
    
    public int getIt6Int() { return this.it6Int; }
  
  
    
    public void setIt6Int(Object it6Obj) { this.it6Int = evaluarValue(it6Obj); }
    ...
    public int getIt8Int() { return this.it8Int; }
  
  
    
    public void setIt8Int(Object it8Obj) { this.it8Int = evaluarValue(it8Obj); }
  
  
    
    public int getIt10Int() { return this.it10Int; }
  
  
    
    public void setIt10Int(Object it10Obj) { this.it10Int = evaluarValue(it10Obj); }
  }


/* Location:              /home/omarv/Documentos/jdeveloper/mywork122140/dup/Manifiesto-001/Manifiesto-0012171724535622629922.war!/WEB-INF/classes/viewManifiesto/manifiestoUsuario/PPRItemFrg.class
